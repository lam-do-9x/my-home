                                    ...
                                    {posts.map(post => (
                                        <tr className="border-b border-gray-200 hover:bg-gray-100" key={post.id} >
                                            ...
                                            <td className="py-3 px-6 text-center">
                                                <div className="flex items-center justify-center">{formatDate(new Date(post.publishedDate))}</div>
                                            </td>
                                            <td className="py-3 px-6 text-center">
                                                <span className={`${handleStatus(post)['style']} py-1 px-3 rounded-full`}>{handleStatus(post)['text']}</span>
                                            </td>
                                            <td className="py-3 px-6 text-center">
                                                <div className="flex item-center justify-center">
                                                    ...
                                                    <div className="w-4 mr-2 transform hover:text-red-500 hover:scale-110 cursor-pointer" onClick={() => showDeleteModal(post)}>
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
