            ...
            <div className="w-full max-w-6xl mx-auto rounded-xl bg-white shadow-lg p-5 text-black">
                <div className="border border-gray-200 overflow-hidden rounded-md">
                    <div className="w-full flex border-b border-gray-200 text-xl text-gray-600">
                        <button className="flex justify-center items-center outline-none focus:outline-none border-r border-gray-200 w-10 h-10 hover:text-indigo-500 active:bg-gray-50">
                        ...
                        <button className="flex justify-center items-center outline-none focus:outline-none border-r border-gray-200 w-10 h-10 mr-1 hover:text-indigo-500 active:bg-gray-50">
                            <svg className="w-6 h-6" viewBox="0 0 24 24">
                        ...
                        <button className="flex justify-center items-center outline-none focus:outline-none border-l border-r border-gray-200 w-10 h-10 hover:text-indigo-500 active:bg-gray-50">
                            <svg className="w-6 h-6" viewBox="0 0 24 24">
                        ...
                        <button className="flex justify-center items-center outline-none focus:outline-none border-r border-gray-200 w-10 h-10 hover:text-indigo-500 active:bg-gray-50">
                            ...
                            <button className="flex justify-center items-center outline-none focus:outline-none border-r mr-1 border-gray-200 w-10 h-10 hover:text-indigo-500 active:bg-gray-50">
                            <svg className="w-6 h-6" viewBox="0 0 24 24">
                    ...
                    <div className="w-full">
                        <iframe x-ref="wysiwyg" className="w-full h-96 overflow-y-auto"></iframe>
                    </div>
                </div >
            </div >
        </div >
