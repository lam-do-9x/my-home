...
export default function DisplayPost({post}) {
    return (
        <Link href={`/${post.slug}`}>
            <div className="max-w-4xl px-10 py-6 my-4 border-b border-gray-300 flex items-center justify-center cursor-pointer">
                ...
                <div className="flex flex-col mx-8 w-2/3">
                    ...
                    <span className="font-light text-gray-600 w-full">{formatDate(new Date(post.publishedDate))}</span>
                </div>
                <div className="mt-2">
