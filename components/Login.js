...
export default function Login() {
    ...
    async function click() {
        const response = await fetchClient('/api/auth', JSON.stringify({ email, password }));
                    ...
                    <form >
                        <div className="flex flex-col mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input onChange={e => setEmail(e.target.value)} type="email" name="email" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="E-Mail Address" />
                            </div>
                        </div>
                        <div className="flex flex-col mb-6">
                        ...
                        <div className="flex w-full">
                            ...
                            <button onClick={click} type="button" className="ml-2 flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2 w-full transition duration-150 ease-in">
