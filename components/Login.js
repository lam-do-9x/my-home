          ...
          <form onSubmit={(e) => handleLogin(e)}>
            ...
            <div className="flex w-full">
              <Link href="/">
                <button
                  type="button"
                  className="mr-2 flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-gray-600 hover:bg-gray-700 rounded py-2 w-full transition duration-150 ease-in"
                >
                  <span>
                    <svg
                      className="h-6 w-6"
              ...
              <button
                ...
                className="ml-2 flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2 w-full transition duration-150 ease-in"
              >
