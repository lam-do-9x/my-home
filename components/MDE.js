...
const videoCommand = {
    ...
    execute: opts => {
        opts.textApi.replaceSelection('[![IMAGE ALT TEXT](http://img.youtube.com/vi/YOUTUBE_VIDEO_ID_HERE/0.jpg)](http://www.youtube.com/embed/YOUTUBE_VIDEO_ID_HERE "Video Title")');
    }
};
